<template>
 <div class="com-draggable--wrapper">
  <div class="com-draggable--container" ref="containerRef">
    <!-- 触发可拖拽组件的区域 -->
    <div class="com-draggable--header">
      <span>···</span>
    </div>
...
.com-draggable--content-text {
  width: 100px;
}
.com-draggable--content {
  width: 100%;
  height: 100%;
  display: flex;
