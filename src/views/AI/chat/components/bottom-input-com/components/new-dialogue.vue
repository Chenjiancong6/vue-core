<template>
  <div class="new-dialogue--container">
    <div class="new-dialogue--capsule" @click="handleNewDialogue">
      ...
      <div class="title">开启新对话</div>
    </div>
  </div>
</template>
<script setup lang="ts">
import { resetMsgList } from '@/views/AI/chat/ai-message-list-store';
import { noStreamLLM } from '@/ai-lib/llm';

/**
 * 1. 清空msgList数组对象
 * 2. 调用noStreamLLM函数，清空模型历史对话
 */
const handleNewDialogue = () => {
  resetMsgList();
  noStreamLLM.clearHistoryMsg();
}
...
.new-dialogue--capsule {
  ...
  color: #4d6bfe;
  &:hover {
    background-color: rgb(149, 188, 241);
  }
  .title {
    margin-left: 5px;
  }
